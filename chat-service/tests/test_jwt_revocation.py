...
@pytest.mark.asyncio
async def test_user_service_allows_non_blacklisted_token(
    client, jwt_token_factory, db_session
):
    ...
    await create_user_profile(
        db_session,
        UserProfileCreate(username="active_user", email="active@example.com"),
    )
